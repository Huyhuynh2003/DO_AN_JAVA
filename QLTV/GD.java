...
public class GD extends JFrame {
	...
	public GD() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(GD.class.getResource("/image/H.png")));
		...
		tabbedPane.addTab("S\u00E1ch", new ImageIcon(GD.class.getResource("/image/D.png")), panel, null);
		...
		btnNewButton_1.setIcon(new ImageIcon(GD.class.getResource("/image/L.png")));
		...
		btnNewButton_1_1.setIcon(new ImageIcon(GD.class.getResource("/image/K.png")));
		...
		btnNewButton_1_2.setIcon(new ImageIcon(GD.class.getResource("/image/J.png")));
		...
		btnNewButton_3.setIcon(new ImageIcon(GD.class.getResource("/image/I.png")));
		...
		tabbedPane.addTab("Độc giả", new ImageIcon(GD.class.getResource("/image/C.png")), panel_1, null);
		...
		btnNewButton_6.setIcon(new ImageIcon(GD.class.getResource("/image/L.png")));
		...
		btnNewButton_6_1.setIcon(new ImageIcon(GD.class.getResource("/image/K.png")));
		...
		btnNewButton_6_2.setIcon(new ImageIcon(GD.class.getResource("/image/J.png")));
		...
		btnNewButton_6_3.setIcon(new ImageIcon(GD.class.getResource("/image/I.png")));
		...
		tabbedPane.addTab("Phi\u1EBFu m\u01B0\u1EE3n", new ImageIcon(GD.class.getResource("/image/E.png")), panel_2, null);
		...
		btnNewButton_5.setIcon(new ImageIcon(GD.class.getResource("/image/L.png")));
		...
		btnNewButton_5_1.setIcon(new ImageIcon(GD.class.getResource("/image/K.png")));
		...
		btnNewButton_5_2.setIcon(new ImageIcon(GD.class.getResource("/image/J.png")));
		...
		btnNewButton_5_3.setIcon(new ImageIcon(GD.class.getResource("/image/I.png")));
